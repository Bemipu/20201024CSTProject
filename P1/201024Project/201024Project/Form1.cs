...
namespace _201024Project {
    public partial class Form1 : Form {
        ...
        public const int tba = 7;
        public const int tbla = 20;
        public TextBox[] tb = new TextBox[tba];
        public Label[] tbl = new Label[tbla];
        public int[,] tbpos = new int[,] { {240, 120},{360, 190},{130, 300},{240, 345},{660, 375},{266, 455},{266, 530} };
        public string[] tblchoice = new string[] { "std", "stb", "int", "char", "float", "string", "c+=2", "c+=24", "c+=25", "c-=1", "c-=2", "c-=24", "cin>>c", "cin<<c", "vector", "iostream", "a,b,A,B", "a,b,y,z", "y,z,Y,Z", "A,B,Y,Z" };
        public int[] ans = new int[] { 15, 0, 3, 12, 16, 7, 10 };
        ...
        public void tb_Init() {
            ...
            for (int i = 0; i < tba; i++) {
                ...
                if (i == 0) {
                    this.tb[i].Size = new System.Drawing.Size(160, 45);
                } else {
            ...
            for (int i = 0; i < tbla; i++) {
                ...
                this.tbl[i].Location = new System.Drawing.Point(1000, 0 + (i*40));
